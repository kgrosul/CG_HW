...
int main( void )
{
	...
	GLuint programID1 = LoadShaders( "SimpleVertexShader.vertexshader", "Triangle1.fragmentshader" );
  GLuint programID2 = LoadShaders( "SimpleVertexShader.vertexshader", "Triangle2.fragmentshader" );
  ...
  do{
    glm::mat4 View       = glm::lookAt(
            glm::vec3(rad*sin(glfwGetTime()),0,rad*cos(glfwGetTime())), // Camera is at (4,3,3), in World Space
